...
const QA = [
  ...
  },
  {
    ...
    a: "Not yet. The app is unreleased — no public 1.0.0 yet. Join the waitlist, or try the interactive design preview on this site. It is a concept mock, not the shipping Electron build.",
  },
  {
