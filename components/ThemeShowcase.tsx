    ...
    <section id="themes" className="mx-auto max-w-7xl scroll-mt-24 px-6 py-24" aria-labelledby="themes-heading">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-[1.02rem] leading-[1.7] text-body">
          ...
          chips, graph nodes, and the frame. This page uses the same tokens.
        </p>
      </div>
      ...
      <div className="mx-auto mt-8 max-w-4xl">
        <ProductFrame caption={`Theme showcase — ${theme.name}`}>
          <Image
